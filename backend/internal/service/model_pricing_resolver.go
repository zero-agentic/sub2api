...
// LookupRequestTierPrice preserves whether a tier was explicitly configured,
// including an intentional zero (free) price.
...
// LookupRequestTierPriceByContext is the presence-aware counterpart of
