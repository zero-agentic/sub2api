...
const BADGE: Record<Platform, string> = {
  ...
  lumina: 'bg-fuchsia-500/10 text-fuchsia-700 border-fuchsia-500/30 dark:text-fuchsia-300',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  lumina: 'bg-fuchsia-500/10 text-fuchsia-700 dark:bg-fuchsia-500/10 dark:text-fuchsia-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  lumina: 'border-fuchsia-500/20 dark:border-fuchsia-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  lumina: 'bg-gradient-to-r from-fuchsia-500 to-purple-600',
}
...
const TEXT: Record<Platform, string> = {
  ...
  lumina: 'text-fuchsia-700 dark:text-fuchsia-300',
}
...
const ICON: Record<Platform, string> = {
  ...
  lumina: 'text-fuchsia-600 dark:text-fuchsia-300',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  lumina: 'bg-fuchsia-600 text-white hover:bg-fuchsia-700 active:bg-fuchsia-800 dark:bg-fuchsia-600/80 dark:hover:bg-fuchsia-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  lumina: 'bg-fuchsia-100 text-fuchsia-800 dark:bg-fuchsia-900/40 dark:text-fuchsia-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  lumina: 'from-fuchsia-500 to-purple-600',
}
