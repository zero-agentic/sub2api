...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'lumina': return 'bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-900/30 dark:text-fuchsia-300'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'lumina': return 'text-fuchsia-700 dark:text-fuchsia-300'
    default: return ''
  }
}
