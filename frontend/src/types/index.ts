...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'lumina'
...
export interface Account {
  ...
  // api_key / session_key / cookie / password / aws_secret_access_key / aws_session_token /
