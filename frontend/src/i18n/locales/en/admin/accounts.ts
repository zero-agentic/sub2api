export default {
    accounts: {
      ...
      lumina: {
        title: 'Lumina personal subscription',
        description: 'Store a BytePlus Lumina Cookie Jar. Email and password are an optional fallback used only when the session expires; interactive verification is never bypassed.',
        email: 'BytePlus email (optional)',
        password: 'BytePlus password (optional)',
        passwordFallbackHint: 'Email and password must be configured together. The password is stored as plaintext by design and is never returned by the API.',
        cookieJar: 'Cookie Jar JSON',
        cookieJarPlaceholder: "[{'{'}\"name\":\"sessionid\",\"value\":\"...\",\"domain\":\".byteplus.com\",\"path\":\"/\"{'}'}]",
        cookieJarHint: 'Paste a JSON array exported from the signed-in browser. Only byteplus.com cookies are accepted.',
        cookieJarInvalid: 'Cookie Jar must be a valid JSON array with name, value, and domain fields.',
        sharkWebId: 'x-shark-web-id (optional)',
        sharkWebIdHint: 'Leave empty unless your captured Lumina requests use a stable x-shark-web-id value.',
        emailPasswordTogether: 'Lumina email and password must be configured together.',
        credentialsRequired: 'Configure a Cookie Jar or both Lumina email and password.',
        modelMappingHint: 'Map your public ModelArk model ID to the Lumina req_key. You can sync the live catalog after creating the account.',
        keepCookieHint: 'Leave empty to keep the stored Cookie Jar.',
        keepPasswordHint: 'Leave empty to keep the stored password.',
      },
      ...
      mediaPromptPlaceholder: 'Example: A cute orange cat astronaut floating in a pastel nebula.',
      mediaPromptDefault: 'A cute orange cat astronaut floating in a pastel nebula.',
      mediaTestHint: 'When an image or video model is selected, this test runs one real generation and previews the result below. Video generation is slow; the test waits up to about 3 minutes.',
      mediaTestMode: 'Mode: Media generation test',
      sendingMediaRequest: 'Sending media generation test request...',
      videoPreview: 'Generated video:',
      videoReceived: 'Received test video',
      // Stats Modal
